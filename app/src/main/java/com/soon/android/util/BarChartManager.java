...
public class BarChartManager {
    ...
    public void showBarChart(List<Float> xAxisValues, List<List<Float>> yAxisValues, List<String> labels, List<Integer> colours) {
        ...
        float barSpace = (float) ((1 - 0.12) / amount / 6); // x4 DataSet
        float barWidth = (float) ((1 - 0.12) / amount / 6 * 9); // x4 DataSet
        ...
        mBarChart.setData(data);
        Log.i("TAG", "showBarChart is finished");
    }
